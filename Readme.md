...
* Студент: [Алексей Филимонов](https://up.htmlacademy.ru/univer-html1/2/user/2113921).
* Наставник: `Гоша А.`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2113921-sedona-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
